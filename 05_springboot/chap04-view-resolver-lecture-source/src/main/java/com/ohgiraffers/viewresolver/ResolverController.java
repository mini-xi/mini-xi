...
public class ResolverController {
    ...
    /* 설명. 스프링의 RedirectAttributes라는 객체에 attr을 담으면 리다이렉트 시에도 값이 유지 된다. */
    ...
    public ModelAndView modelAndViewRedirect(ModelAndView mv) {
        ...
        /* 설명. ModelAndView를 통한 리다이렉트 시에는 addObject 한 것이 parameter로 넘어간다.(?가 있는 쿼리스트링 형태로 넘어간다. ex) ?message2=ModelAndView를+이용한+redirect)*/
