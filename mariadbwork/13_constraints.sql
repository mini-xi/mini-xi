...
(2, 'user03', 'pass03', '김똥개', '남', '010-4321-9876', 'dog9@gmail.com');
...
-- (user_no, user_id, user_pwd, user_name, gender, phone, email)
-- VALUES
-- (1, 'user03', 'pass03', '김똥개', '남', '010-777-7777', 'dog9@gmail.com');
...
-- 자식테이블에서 FOREIGN KEY 제약조건 컬럼에 NULL값으로 INSERT
INSERT 
  INTO user_foreignkey1
(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
VALUES
(3, 'user03', 'pass03', '이순신', '남', '010-777-7777', 'lee222@gmail.com', NULL);  -- 이 행들만큼은 부모테이블과 관계가 없다
...
SELECT * FROM user_grade;
DELETE FROM user_grade WHERE grade_code = 20; -- user foreignkey1 테이블은 삭제룰을 적용하지 않고 20을 참조한 데이터가 있다.
