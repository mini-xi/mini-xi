...
public class Application {
    public static void main(String[] args) {
         ...
         *  super() : 부모로부터 생성자를 물려받지 못 했을 때 부모 클래스에 있는 생성자를 활용하기 위해 사용
         * */

        Product product1 = new Product();
        System.out.println(product1);

        Product porduct2 = new Product("p01", "플레이데이터", "자바", 1000, new java.util.Date());
        System.out.println("porduct2 = " + porduct2);
