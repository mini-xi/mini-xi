...
public class Application {
     ...
     *  추상화, 캡슐화, 상속, 다형셩을 적용하여 유지보수성을 고려한 응집력 높고 결합도 낮은
    ...
    public static void main(String[] args) {
        ...
        com.ohgiraffers.section01.user_type.Member member = new com.ohgiraffers.section01.user_type.Member();
        com.ohgiraffers.section01.user_type.Member member2 = new com.ohgiraffers.section01.user_type.Member();
        ...
        com.ohgiraffers.section01.user_type.Member renameMember = printMember(member);
        System.out.println("renameMember.age = " + renameMember.age);
        System.out.println("renameMember.age = " + Arrays.toString(renameMember.hobby));
    }

    private static com.ohgiraffers.section01.user_type.Member printMember(Member member) {
