...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        int global = 20;                            // 지역변수
        System.out.println("지역변수 global 출력: " + global);
        System.out.println("전역변수 global 출력: " + Application3.global);
        ...
        * */
        ...
        app3.testMethod(19);
//        app3.testMethod(15, 16);                  // 순서와 타입과 갯수가 일치해야함

        app3.testMethod('a');
        app3.testMethod((int)12.34);
        int age = 30;
        System.out.println("당신의 나이는 " + age + "세 맞나요?");
        app3.testMethod(3 * 2);
    }
