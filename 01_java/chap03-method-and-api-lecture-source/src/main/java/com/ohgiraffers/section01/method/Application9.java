...
public class Application9 {
    ...
    public static void main(String[] args) {
        ...
        cal.plusTwoNumbers(100, 50);
        System.out.println("두 수의 합: " + cal.plusTwoNumbers(100, 50));

        /* 설명. private와 같이 접근 제어자에 따라 다른 클래스에서 접근이 불가능한 메소드가 있을 수 있다. */
//        System.out.println("두 수 중에 작은 값: " + cal.minTwoNumbers(first, second));

        /* 설명. static 메소드는 클래스명. 을 붙여 호출한다. */
        System.out.println("두 수 중에 큰/ 값: " + Calculator.maxNumberOf(first, second));
    }
}
