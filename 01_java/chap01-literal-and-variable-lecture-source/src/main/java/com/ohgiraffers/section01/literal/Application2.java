...
public class Application2 {
    public static void main(String[] args) {
        ...
        System.out.println(123 / 10);
        System.out.println(123 % 10);            // modulus 연산자(mod 연산자): 제수로 나눈 나머지 구하기
        ...
        System.out.println('a' + 1);            // 결과값 : 98 ,   a를 97로 인식
        ...
        System.out.println("hello" + "world");          // 문자열간의 연산은 덧셈(이어붙이기)만 가능하다.
...
//        System.out.println("hello" % "world");
        ...
        /* 필기. 문자열과 다른 형태의 값 연산은 다른 형태를 문자열로 바꾸고 이어붙인다 */

        /* 설명. 이향연산자들의 묶음에서 좌측에서부터 이항씩 연산하면 아래 코드의 결과를 이해할 수 있다. */
        System.out.println(123 + 3 + "hello world" + 123 + 3);           // 결과: "126hello world1233"
