...
public class Application3 {
    public static void main(String[] args) {
        ...
        **/
        ...
        /* 목차. 1-1. 동일한 범위 내에서 동일한 변수명을 가질 수 없다. */ // 범위 -> 같은 중괄호 내의 범위
        int age = 20;
//        int age < 같은 변수명 안된다.
        age = 30;
...
//        int ?harp = 12;
        ...
        /* 목차. 2-1. 변수명의 길이 제한은 없으나 적당해야한다. */
        int asfjklajlkgjdlkdjkljgrjkjkjireiol;
...
//        int max_age = 50;
        ...
        /* 목차. 2-3. 한글로 변수명을 찾는 것은 가능하지만, 권장하지는 않는다. */
        int 나이 = 19;
