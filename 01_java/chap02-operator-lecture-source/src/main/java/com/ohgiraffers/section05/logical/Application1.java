...
public class Application1 {
    public static void main(String[] args) {
         ...
         *    1-1. &&(논리 AND) 연산자: 두 개의 논리식 모두 참일 경우 참을 반환, 둘 중 하나라도 거짓인 경우 거짓을
         *                            반환하는 연산자이다.
         *    1-2. ||(논리 OR) 연산자 : 두 개의 논리식 중 둘 중 하나라도 참일 경우 참을 반환, 둘 다 모두 거짓인 경우
         *                            거짓을 반환하는 연산자이다.
        ...
        * */
        ...
        /* 목차. 1. 논리 연산자 결과값 확인 */
        System.out.println("============ 논리 연산자 결과값 확인 ============");
        ...
        System.out.println("========= 논리식에 논리연산자 활용 =============");
