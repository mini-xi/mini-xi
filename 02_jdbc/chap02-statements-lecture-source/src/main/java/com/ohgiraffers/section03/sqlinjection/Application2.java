...
/* 설명.
 *  Statement와 달리 placeholder(?)(위치 홀더)를 통한 sql injection 공격을 막을 수 있게 작성되어 있어
...
public class Application2 {
    ...
    public static void main(String[] args) {
         ...
         *  붙여준다.
        * */
//        SELECT * FROM EMPLOYEE WHERE EMP_ID = '200' AND EMP_NAME = ''' OR 1=1 AND EMP_ID = ''200';  // 이런 식으로 동작함
