...
public class SimpleJPQLTests {
     ...
     *   3. 키워드는 대소문자를 구분하지 않지만, 엔티티와 속성은 대소문자를 구분함에 유의한다.
     *   4. 엔티티 별장을 필수로 사용해야 하며 별칭 없이 작성하면 에러가 발생한다.(?) <- 지금 버전에선 에러 발생 X
    * */
    ...
    * */
    ...
    @Test
    public void Query를_이용한_단일행_단일열_조회_테슽트() {
    ...
    /* 설명. SQL과 다르지 않은 몇가지 종류의 연산자만 테스트 해보자. */
    @Test
