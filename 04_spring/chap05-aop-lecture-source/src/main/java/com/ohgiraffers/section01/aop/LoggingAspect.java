...
public class LoggingAspect {
     ...
     *      이상인 모든 메소드이며 접근제어자와 반환형은 상관 없음/ annotation이랑 stu 사이에 .. 이 있기 때문에 아무 클래스나 와도 된다는 말도됨
     * */
     ...
     *  : 포인트 컷으로 패치된 조인 포인트
     * */
//    @Before("execution(* com.ohgiraffers.section01.aop.*Service.*(..))") // 메소드 명도 상관없고 타입도 상관없고, service로 끝나는 모든 메소드 전에 시작
...
//        System.out.println("After Advice 동작");
    ...
    public void logAfterReturning(JoinPoint joinPoint, Object result) {
        ...
        /* 설명. AfterReturning Advice를 활용한 반환값 가공도 가능하다.(반환 값을 가공해서 조작했음) */
     ...
     *  AroundAdvice 조인포인트 매개변수는 ProceedingJoinPoint로 고정되어 있다.
    ...
    * */
    /* 필기. 파워풀하기 때문에 사용할 때 조심해야 한다. Advice들을 너무 많이 써야되면 Around쓰는데 실제로는 리소스를 너무 많이 잡아먹기 때문에 가능한 X */
    @Around("logPointcut()")
